      ...
      >
        ...
        {!isCollapsed && (
          <>
            <button
              onClick={onNewNote}
              className="cursor-pointer bg-[#266293] hover:bg-blue w-full py-1 rounded-md font-bold text-[16px] pt-2"
            >
              New Note
            </button>
            <div className="flex flex-col gap-4">
              <div className="flex items-center justify-between">
                <h2 className="font-bold text-[12px] text-white-opacity-50 pt-1">
                  Your Notes
                </h2>
                {contentManager && (
                  <span className="text-[10px] text-white-opacity-30 bg-light-grey px-2 py-1 pt-2 rounded">
