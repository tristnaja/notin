...
function GenerateNoteModal({ isOpen, onClose }: GenerateNoteModalProps) {
    ...
    return (
        <div onClick={onClose} className="z-100 top-0 bottom-0 left-0 right-0 fixed bg-black-opacity-70 flex justify-center items-center">
                ...
                {isDocument ? (
                    <form action="post" className="bg-[#141414]/60 backdrop-blur-sm p-8 rounded-b-xl flex flex-col justify-center items-center gap-4">
                        ...
                        <div className="w-full flex justify-between items-center gap-10">
                            <button type="submit" className="pt-1 bg-blue hover:bg-blue-opacity-40 text-white rounded-md w-full h-[48px] text-[1rem] font-bold cursor-pointer mt-2">
                                Generate
                            </button>
                            <button type="button" onClick={onClose} className="pt-1 bg-light-grey hover:bg-grey text-white rounded-md w-full h-[48px] text-[1rem] font-bold cursor-pointer mt-2">
                                Cancel
                            </button>
                        </div>
                    </form>
